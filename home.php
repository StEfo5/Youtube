			...
			<div class="col-10 bg-light pt-3" style="">
				<div class="row">
					<?php 
						...
						$q = mysqli_query($con, "SELECT * FROM videos INNER JOIN users ON videos.user_id = users.id WHERE users.id = {$_GET['id']}");
					...
					<div class="col-3"> <!--ВИДЕО -->
						<div class="embed-responsive embed-responsive-16by9 mb-3">
							<iframe class="embed-responsive-item" src="<?php echo $str['source'] ?>" fram="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
						</div>
						<div class="row">
							<div class="col-3 text-center">
								<img src="<?php echo $str['img'] ?>" class="w-75 rounded-circle">
							</div>
							<div class="col-9">							
								<h5><?php echo $str['videoname'] ?></h5>
								<a href=""><p class="font-weight-bold mb-0"><?php echo $str['chanelname'] ?></p></a>	
								<p class="text-secondary"><?php echo $str['descr'] ?></p>
							</div>
						</div>						
					</div> <!--КОНЕЦ ВИДЕО -->	
					<?php 
